const DB = {
  "cards": {
    "ironclad": {
      ...
      "EXPECT_A_FIGHT": {
        ...
        "anti": [],
        "notes": "Gain 1 energy per attack in hand. With 4 attacks = 4 free energy. Insane burst turns.",
        "mech": [
          "energy_gain",
          "conditional"
        ],
      ...
      "TAUNT": {
        ...
        "anti": [],
        "notes": "Block + Vulnerable. Balanced defense and offense. Reduce incoming damage while boosting attacks.",
        "mech": [
          "block",
          "debuff"
        ],
      ...
      "BREAKTHROUGH": {
        ...
        "anti": [],
        "notes": "AoE pressure for multi-enemy fights.",
        "mech": [
          "damage",
          "aoe"
        ],
      ...
      "POMMEL_STRIKE": {
        ...
        "anti": [],
        "notes": "Attack with draw. Decent early card.",
        "mech": [
          "damage",
          "draw"
        ],
      ...
      "PERFECTED_STRIKE": {
        ...
        "notes": "More Strikes in deck = more damage. Only in Strike-heavy builds.",
        "mech": [
          "damage",
          "conditional"
        ],
      ...
      "CLEAVE": {
        ...
        "anti": [],
        "notes": "Good early multi-target clearing. Outclassed mid-late game.",
        "mech": [
          "damage",
          "aoe"
        ]
      ...
      "BODY_SLAM+": {
        ...
        "anti": [],
        "notes": "Upgraded Body Slam is 0-cost - much better.",
        "mech": [
          "block_conversion",
          "damage",
          "zero_cost"
      ...
      "BLOOD_FOR_BLOOD": {
        ...
        "anti": [],
        "notes": "Costs 1 less for each time you lost HP this combat. Often 0-cost heavy hit.",
        "mech": [
          "damage",
          "cost_reduction",
          "self_damage"
      ...
      "CHARONS_ASHES": {
        ...
        "anti": [],
        "notes": "Whenever you exhaust a card deal 3 damage to ALL enemies. With Corruption = AoE every skill.",
        "mech": [
          "exhaust_payoff",
          "damage",
          "aoe"
      ...
      "DEAD_BRANCH": {
        ...
        "anti": [],
        "notes": "Relic not a card - but Havoc: Exhaust a random card from your draw pile.",
        "mech": [
          "exhaust"
        ],
        "role": "generator"
    ...
    "ironclad": [
      {
        ...
        "coreThresh": 3,
        "supportThresh": 2,
        "description": "Stack Strength with Inflame/Demon Form, then deal massive multi-hit damage"
      },
      {
        "id": "exhaust",
        "name": "Exhaust Engine",
        ...
        "coreThresh": 4,
        "supportThresh": 2,
        "description": "Exhaust cards to trigger Dark Embrace, Feel No Pain, Corruption combos"
      },
      {
        "id": "block",
        ...
        "coreThresh": 3,
        "supportThresh": 1,
        "description": "Retain block with Barricade, convert to damage with Body Slam, Juggernaut, Grapple"
      },
      {
        "id": "self_damage",
        "name": "Self-Damage",
        ...
        "coreThresh": 3,
        "supportThresh": 2,
        "description": "Use Bloodletting/Offering/Hemokinesis to trigger Rupture for free Strength"
      }
    ],
    "silent": [
      {
  ...
  "combos": [
    ...
    },
    {
      ...
      "bonus": 2.0,
      "reason": "Corruption exhausts every skill — Charon's Ashes deals 3 AoE per exhaust. Free AoE on every skill."
    },
    {
    ...
    },
    {
      ...
      "offeredCard": "Corruption",
      "bonus": 1.8,
      "reason": "Corruption exhausts all skills, each triggering Charon's Ashes — constant free AoE"
    },
    {
      "deckCard": "Feel No Pain",
      "offeredCard": "Dark Embrace",
    ...
    {
      "deckCard": "Rupture",
      "offeredCard": "Blood For Blood",
      "bonus": 1.0,
      "reason": "Blood For Blood costs HP — triggers Rupture for Strength each time"
    },
    {
